...
class Fightdialog extends JDialog implements ActionListener{
    ...
    JButton prop = new JButton("道具");
    JButton leave = new JButton("逃跑");
    JButton skill = new JButton("武功");
    
    //地图随机遇怪的构造方法
    Fightdialog(Player player) {
        temp = (int)(Math.random()*10+4)/4;
    ...
    public class JPanel1 extends JPanel{
        ...
        protected void paintComponent(Graphics g){
           ...
           g.drawString("名字： "+player.name, 50, 120);//名字
           g.drawString("等级： "+player.level, 50, 140);
           g.drawString("生命： "+player.hpp+"/"+player.hp, 50, 160);
           g.drawString("内功： "+player.mpp+"/"+player.mp, 50, 180);
           g.drawString("外力： "+player.attactt, 50, 200);
    ...
    public class JPanel2 extends JPanel{
        ...
        protected void paintComponent(Graphics g){
           ...
           g.drawString("名字： "+player[i].name, 50+(i%2*150), 110+(i/2)*200);//名字
           g.drawString("等级： "+player[i].level, 50+(i%2*150), 130+(i/2)*200);
           g.drawString("生命： "+player[i].hpp+"/"+player[i].hp, 50+(i%2*150), 150+(i/2)*200);
           ...
           g.drawString("名字： "+player[i].name, 50+(i%2*150), 110+(i/2)*200);//名字
           g.drawString("等级： "+player[i].level, 50+(i%2*150), 130+(i/2)*200);
           g.drawString("生命： "+0+"/"+player[i].hp, 50+(i%2*150), 150+(i/2)*200);
           g.drawString("内功： "+player[i].mpp+"/"+player[i].mp, 50+(i%2*150), 170+(i/2)*200);
    ...
    if(e.getActionCommand().equals("道具")){
        ...
        if(e.getActionCommand().equals("武功")){
