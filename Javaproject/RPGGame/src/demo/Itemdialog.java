...
public class Itemdialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ImageIcon icon = new ImageIcon("./util/道具店.png");
...
// TODO add your handling code here:
    ...
    jTextArea1.setText(item[jList1.getSelectedIndex()].definition+"\n"
            +"加血 "+item[jList1.getSelectedIndex()].hp+"\n"
            +"加内力 "+item[jList1.getSelectedIndex()].mp);
...
// TODO add your handling code here:
      Choosedialog1 choose =  new Choosedialog1("您的金子现在有"+player.money+" 。  该物品价格是 "+item[jList1.getSelectedIndex()].price +"钱。"+ "您是否要买？");
      if(choose.getI()==1){
